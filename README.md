...
📖 [Concept & scénario](docs/SILVERBRAIN.md) · 🗺️ [Feuille de route](docs/SILVERBRAIN-ROADMAP.md) · 🧬 [Modèle du profil](docs/SILVERBRAIN-PROFIL.md) · 🗣️ [Contrat de style](docs/SILVERBRAIN-STYLE.md) · 🔌 [Connecteurs MCP](docs/SILVERBRAIN-MCP.md) · 🎨 [Maquettes](docs/ui/landing.html) · 💼 [Dossier SaaS](docs/SILVERBRAIN-SAAS.md)
